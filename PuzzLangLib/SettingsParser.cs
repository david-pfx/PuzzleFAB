...
namespace PuzzLangLib {
  class SettingsParser {
    ...
    Dictionary<OptionSetting, Func<SettingsParser, OptionSetting, string, bool>> _settinglookup = 
      ...
      { OptionSetting.norepeat_action,          (x,s,v) => x.ParseBool(s, v)    },
      ...
      { OptionSetting.noundo,                   (x,s,v) => x.ParseBool(s, v)    },
      { OptionSetting.noaction,                 (x,s,v) => x.ParseBool(s, v)    },
      { OptionSetting.norestart,                (x,s,v) => x.ParseBool(s, v)    },
