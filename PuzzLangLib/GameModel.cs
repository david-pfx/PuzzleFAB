...
namespace PuzzLangLib {
  ...
  public class GameModel {
    ...
    public bool InMessage { get { return _modelstate == ModelState.Message || _messages.Any(); } }
    ...
    public string CurrentMessage { get { return _messages.FirstOrDefault(); } }
    ...
    public string Status { get { return _states.Any() ? _states.Last().Status : null; } }

    // for testing only
    public Level FirstLevel { get { return _states.First().Level; } }
    public Level LastLevel { get { return _states.Last().Level; } }
    internal LevelKind CurrentLevelKind { get { return GameDef.LevelIndex[_levelindex].Item1; } }
    ...
    public void AcceptInputs(string inputs) {
      ...
      if (GameOver)
        if (Logger.Level >= 2) ShowLevel("gameover");
    }
